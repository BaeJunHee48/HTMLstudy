window.onload = function () {
  ...
  // 인기 물품 화면에 출력 기능
  let POPULAR_GOOD;
  let popularshow = 1; //목록 중에 0번을 보여준다.
  ...
  // 공지사항 화면 출력
  let NOTICE_ARR;
  let noticeTag = document.getElementById("data-notion");
  // 물품소식 화면 출력
  let GOODNEWS_ARR;
      ...
      if (index !== 0) {
        ...
        <div class="new-box">
          <a href="${item.link}" class="new-box-img">
            <img src="../images/${item.pic}" alt = "${item.titel}"/>
          </a>
  ...
  `;
    ...
    <div class = "swiper-slide">
      <a href = "${item.link}">
        <span class = "popular-cate-icon" style=
  ...
  function showBannerArr() {
    ...
    const swBanner = new Swiper(".sw-banner", {
      ...
      spaceBetween: 0,
      navigation: {
        prevEl: ".banner .slid-prev",
        nextEl: ".banner .slid-next",
      },
    });
  }
